    ...
    <div class="w-full max-w-xl mx-auto mt-10 p-8 bg-white shadow-lg rounded-2xl border border-gray-200">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                ...
                <x-text-input id="nik" class="mt-1 w-full" type="text" name="nik" :value="old('nik')" required autocomplete="off" />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="npwp" class="mt-1 w-full" type="text" name="npwp" :value="old('npwp')" autocomplete="off" />
            ...
            <div class="mb-4">
                ...
                <x-text-input id="phone_number" class="mt-1 w-full" type="text" name="phone_number" :value="old('phone_number')" required autocomplete="tel" />
