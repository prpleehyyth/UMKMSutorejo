<x-guest-layout>
    <div class="w-full max-w-md mx-auto mt-10 p-8 bg-white shadow-lg rounded-2xl border border-gray-200">
        <h2 class="text-3xl font-extrabold text-center text-black-800 mb-6">Masuk ke Akun Anda</h2>
        ...
        <form method="POST" action="{{ route('login') }}">
            ...
            <div class="flex items-center justify-between mt-4">
                ...
                @if (Route::has('password.request'))
                    <a class="text-sm text-blue-600 hover:underline hover:text-blue-800" href="{{ route('password.request') }}">
                        Lupa password?
                    </a>
                @endif
            </div>
            ...
            <div class="mt-6">
                <x-primary-button class="w-full justify-center py-2 text-lg bg-blue-800 hover:bg-blue-900">
                    {{ __('LOGIN') }}
                </x-primary-button>
            </div>
        </form>
